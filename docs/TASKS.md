...
| GOK-MMO-228 | ⏳ | 1 | Blocked input ticket for production art pass: provide (1) style reference set (2-4 examples), (2) target sprite resolution + zoom, (3) v1 equipment slot list, (4) v1 weapon/item visual list (at least saber + longsword variants), and (5) v1 per-action frame-count contract. |
