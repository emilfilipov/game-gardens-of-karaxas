...
- Active reboot output is generated by `tools/generate_ui_concept_radial_reboot.py` into `concept_art/option_radial_reboot_blackwhite/pass_01`, with radial graph navigation and black/white theming mapped to login/register/play/create/system/update feature surfaces.
