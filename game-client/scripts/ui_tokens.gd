...
const COLORS: Dictionary = {
	"panel_bg": Color(0.96, 0.97, 0.99, 0.95),
	"panel_bg_alt": Color(0.93, 0.95, 0.98, 0.95),
	"panel_bg_deep": Color(0.89, 0.93, 0.98, 0.96),
	"panel_bg_soft": Color(0.98, 0.95, 0.89, 0.95),
	"panel_bg_highlight": Color(0.96, 0.90, 0.78, 0.95),
	"row_bg": Color(0.95, 0.97, 1.0, 0.95),
	"row_bg_selected": Color(0.85, 0.92, 0.98, 0.98),
	"panel_border": Color(0.61, 0.70, 0.82, 0.84),
	"panel_border_soft": Color(0.70, 0.77, 0.86, 0.64),
	"divider": Color(0.58, 0.66, 0.78, 0.42),
	"text_primary": Color(0.15, 0.20, 0.29),
	"text_secondary": Color(0.26, 0.34, 0.45),
	"text_muted": Color(0.41, 0.48, 0.57),
