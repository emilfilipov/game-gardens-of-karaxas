...
const COLORS: Dictionary = {
	"panel_bg": Color(0.10, 0.05, 0.07, 0.96),
	"panel_bg_alt": Color(0.16, 0.08, 0.10, 0.95),
	"panel_bg_deep": Color(0.07, 0.04, 0.05, 0.98),
	"panel_bg_soft": Color(0.22, 0.10, 0.12, 0.95),
	"panel_bg_highlight": Color(0.32, 0.14, 0.18, 0.95),
	"row_bg": Color(0.18, 0.09, 0.11, 0.95),
	"row_bg_selected": Color(0.34, 0.16, 0.20, 0.98),
	...
	"button_hover": Color(0.30, 0.14, 0.17, 1.0),
	"button_pressed": Color(0.38, 0.18, 0.22, 1.0),
	"button_primary": Color(0.64, 0.35, 0.27, 1.0),
	"button_primary_hover": Color(0.73, 0.40, 0.30, 1.0),
	"button_primary_pressed": Color(0.54, 0.29, 0.23, 1.0),
