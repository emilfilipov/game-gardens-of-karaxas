...
class ReleasePolicy(Base):
    ...
    latest_content_version_key: Mapped[str] = mapped_column(String(64), nullable=False, default="unknown")
    min_supported_content_version_key: Mapped[str] = mapped_column(String(64), nullable=False, default="unknown")
